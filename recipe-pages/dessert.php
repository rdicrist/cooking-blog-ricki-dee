...
<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left" id="mySidebar">
    <a href="#recipeone"  class="w3-bar-item w3-button">Dessert Recipe One</a>
    <a href="#recipetwo"  class="w3-bar-item w3-button">Dessert Recipe Two</a>
    <a href="#recipethree"  class="w3-bar-item w3-button">Dessert Recipe Three</a>
...
<hr id="recipeone">
    ...
    <div class="title"><h1>Dessert Recipe One!</h1></div>
    <div class="recipe">
